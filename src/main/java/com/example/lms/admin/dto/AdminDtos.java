...
public class AdminDtos {
    public record CourseCreateRequest(String courseCode, String title, String description, String professor, Integer price) {}
    public record CourseUpdateRequest(String title, String description, String professor, Integer price, Boolean active) {}
