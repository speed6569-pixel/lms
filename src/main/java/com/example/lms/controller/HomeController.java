...
public class HomeController {
    ...
    private List<Course> sampleCourses() {
        return List.of(
                new Course(1, "전공", "공학", "컴퓨터공학", "웹프로그래밍", "2026-03-01", 40, "김교수", "전공", "주간", 2, "CSE201", "01", 3, "월 10:00-12:00", "정원 40", "신청가능", "개발", "컴퓨터공학"),
                new Course(2, "전공", "공학", "컴퓨터공학", "데이터베이스", "2026-03-01", 35, "이교수", "전공", "주간", 3, "CSE301", "02", 3, "화 13:00-15:00", "정원 35", "신청가능", "기획/마케팅", "컴퓨터공학"),
                new Course(3, "기타", "교양", "공통", "커뮤니케이션 스킬", "2026-03-02", 60, "박교수", "교양", "야간", 1, "GEN101", "01", 2, "수 19:00-21:00", "정원 60", "잔여적음", "경영", "공통"),
                new Course(4, "전공", "공학", "소프트웨어", "알고리즘", "2025-09-01", 30, "최교수", "전공", "주간", 2, "SWE220", "01", 3, "목 09:00-11:00", "정원 30", "신청가능", "영업", "소프트웨어")
        );
    }
